...
/**
 * @desc Hàm queryBuilder giúp xây dựng truy vấn Mongoose dựa trên các tham số truy vấn từ client, hỗ trợ phân trang, sắp xếp, tìm kiếm và lọc dữ liệu.
 * @param {object} Model - Mongoose model đại diện cho collection cần truy vấn.
 * @param {object} queryParams - Đối tượng chứa các tham số truy vấn từ client, bao gồm page, limit, sort, order, search, searchFields, includeDeleted và các bộ lọc khác.
 * @param {object} options - Đối tượng tùy chọn bổ sung, có thể chứa thông tin về population.
 * @return {object} Trả về một đối tượng chứa dữ liệu kết quả và thông tin phân trang.
 *
 */
...
/**
 * @desc Hàm applyFilter giúp áp dụng các bộ lọc từ query parameters vào điều kiện truy vấn MongoDB.
 * @param {string} key - Tên của trường cần lọc.
 * @param {string} value - Giá trị của bộ lọc.
 * @param {object} conditional - Đối tượng điều kiện truy vấn MongoDB sẽ được cập nhật dựa trên bộ lọc.
 *
 */
